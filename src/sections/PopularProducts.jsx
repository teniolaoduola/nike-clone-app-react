...
const PopularProducts = () => {
  return (
    ...
    <div className="flex flex-col justify-start gap-5">
      ...
      <p className="lg:max-w-lg mt-2 font-montserrat text-slate-600">Experience top-notch quality and style with our sought-after selections. Discover a world of comfort, design, and value</p>
    </div>
